  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          position: "fixed",
          left: isSidebarCollapsed ? 100 : 280,
          right: 20,
          bottom: 18,
          height: 72,
          borderRadius: 18,
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="up-next-scroll" style={{
                display: "flex",
                flexDirection: "column",
                gap: 10,
                flex: 1,
      ...
      <style>{`
        ...
        .up-next-scroll::-webkit-scrollbar-track {
          background: transparent;
        }
        .up-next-scroll::-webkit-scrollbar-thumb {
          background: rgba(139,92,246,0.6);
          border-radius: 3px;
          transition: background 0.2s;
        }
        .up-next-scroll::-webkit-scrollbar-thumb:hover {
